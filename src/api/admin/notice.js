...
export function getAllNoticeMsg() {
  return request({
    url: "/admin/sysmsguser/notice/all",
    method: "get",
  });
}
export function getAllSysNoticeMsg() {
  return request({
    url: "/admin/sysmsguser/sysnotice/all",
    method: "get",
  });
}
...
export function setReadStatus(id) {
  return request({
    ...
    data: {
      id: id,
      status: 1,
      finishTime: dateFormat(new Date()).substring(
        0,
        dateFormat(new Date()).indexOf(" ")
      ),
    },
  });
}
...
export function markRead(mid) {
  return request({
    url: "/admin/sysmsguser/mark/read/" + mid,
    method: "post",
  });
}
