<template>
  <basic-container>
    ...
    <excel-upload ref="excelUpload"
                  title="用户信息导入"
                  url="/staff/zzjgworkerskillgrade/import"
...
<script>
import { option } from "@/views/staff/staffInfo/option/child/workerskillgrade";
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      this.downBlobFile(
        "/staff/zzjgworkerskillgrade/export",
        this.search,
        "教职工职业技术等级及职务信息表.xlsx"
      );
    },
    // 获取数据
