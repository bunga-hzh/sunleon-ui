...
import { option } from "@/views/staff/teacher/teacherInfo/option/salary";
...
export default {
  ...
  methods: {
    async getObj() {
      ...
      this.obj = {
        ...res.data.records[0],
        xjdjfj: validatenull(res.data.records[0].xjdjfj)
          ? undefined
          : splitUploadData(res.data.records[0].xjdjfj),
      };
    },
    submit(form, loading) {
