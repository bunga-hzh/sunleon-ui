<template>
  <div class="personal_container">
    <div class="personal_info_portrait">
        ...
        <basic-container style="height: 100%">
          ...
          <div class="other_info">
            <ul>
              ...
              <li>
                <i class="el-icon-office-building" /> 部门：<span>组织部</span>
              </li>
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item label="当前状态" prop="dqztm">
                    <el-select v-model="info_form.dqztm" placeholder="请选择">
                      <el-option
                ...
                <el-col :span="6">
                  <el-form-item label="健康状况" prop="jkzkm">
                    <el-select v-model="info_form.jkzkm" placeholder="请选择">
                      <el-option
                ...
                <el-col :span="6">
                  <el-form-item label="婚姻状况" prop="hyzkm">
                    <el-select v-model="info_form.hyzkm" placeholder="请选择">
                      <el-option
      ...
      <el-collapse accordion>
        <el-collapse-item title="学历及学位子集">
          <div>
            ...
            >
              ...
              <el-table-column label="入学时间" prop="rxsj"> </el-table-column>
              <el-table-column label="学习形式" prop="xxxsm"> </el-table-column>
              <el-table-column label="学校" prop="xx"> </el-table-column>
              <el-table-column label="专业/系" prop="sxzym"> </el-table-column>
              <el-table-column label="所获学位" prop="hdxwm"> </el-table-column>
        ...
        <el-collapse-item title="个人履历子集（校外）">
          <el-table
            ...
            :header-cell-style="{ textAlign: 'center' }"
          >
            <el-table-column label="超始时间" prop="qssj"> </el-table-column>
            <el-table-column label="终止时间" prop="zzsj"> </el-table-column>
            <el-table-column label="所在单位" prop="szdw"> </el-table-column>
            ...
            <el-table-column align="center">
              ...
              <template slot-scope="scope">
                <el-button type="text" @click="editChildRow('grll', scope.row)"
                  >修改</el-button
                >
                <el-button type="text" @click="delChildRow('grll', scope.row)"
                  >删除</el-button
                >
              </template>
            </el-table-column>
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialogVisible_grll = false">取 消</el-button>
              <el-button type="primary" @click="submitChild('grll', grll_form)"
                >确 定</el-button
              >
            </span>
          </el-dialog>
        ...
        <el-collapse-item title="家属子集">
          ...
          >
            ...
            <el-table-column label="政治面貌" prop="zzmmm"> </el-table-column>
            <el-table-column label="单位名称" prop="dwmc"> </el-table-column>
            <el-table-column label="家庭成员职业" prop="jtcyzym">
            </el-table-column>
            <el-table-column label="联系方式" prop="lxfs"> </el-table-column>
            <el-table-column align="center">
              <template slot="header">
              ...
              <template slot-scope="scope">
                <el-button
                  ...
                  >修改</el-button
                >
                <el-button type="text" @click="delChildRow('family', scope.row)"
                  >删除</el-button
                >
              </template>
            </el-table-column>
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialogVisible_family = false">取 消</el-button>
              <el-button
                type="primary"
              ...
              >
                ...
                <el-col :span="6">
                  <el-form-item label="人员类别" prop="rylb">
                    <el-select v-model="office_form.rylb" placeholder="请选择">
                      <el-option
                ...
                <el-col :span="6">
                  <el-form-item label="岗位类别" prop="gwlbm">
                    <el-select v-model="office_form.gwlbm" placeholder="请选择">
                      <el-option
      ...
      <el-collapse accordion>
        <el-collapse-item title="校内职务表">
          ...
          >
            ...
            <el-table-column label="职务名称" prop="zwmc"> </el-table-column>
            <el-table-column label="任职方式" prop="rzfsm"> </el-table-column>
            <el-table-column label="任免职文号" prop="rmzwh"> </el-table-column>
            <el-table-column label="职务级别" prop="zwjbm"> </el-table-column>
            ...
            <el-table-column align="center">
              ...
              <template slot-scope="scope">
                <el-button
                  ...
                  >修改</el-button
                >
                <el-button type="text" @click="delChildRow('leader', scope.row)"
                  >删除</el-button
                >
              </template>
            </el-table-column>
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialogVisible_leader = false">取 消</el-button>
              <el-button
                type="primary"
        ...
        <el-collapse-item title="专业技术职务子集">
          ...
          >
            ...
            <el-table-column label="聘任情况" prop="prqkm"> </el-table-column>
        ...
        <el-collapse-item title="工人技术等级及职务子集">
          ...
          >
            ...
            <el-table-column label="证书编号" prop="zsbh"> </el-table-column>
            <el-table-column label="职业工种" prop="grgzm"> </el-table-column>
            <el-table-column label="上传电子证件" prop="szdczj">
            </el-table-column>
            <el-table-column align="center">
              <template slot="header">
                <el-button type="text" @click="openChild('workerskillgrade')"
                  ><i class="el-icon-plus"></i>添加</el-button
                >
              </template>
              <template slot-scope="scope">
          ...
          >
            ...
            >
              ...
              <el-form-item label="批准技术职务单位名称" prop="pzjszwdwmc">
                <el-input v-model="workerskillgrade_form.pzjszwdwmc"></el-input>
              </el-form-item>
            ...
            <span slot="footer" class="dialog-footer">
              ...
              <el-button
                type="primary"
                @click="submitChild('workerskillgrade', workerskillgrade_form)"
                >确 定</el-button
              >
            </span>
          </el-dialog>
        ...
        <el-collapse-item title="社会兼职子集">
          ...
          >
            ...
            <el-table-column label="任职组织" prop="rzzz"> </el-table-column>
            <el-table-column label="组织类型" prop="zzlx"> </el-table-column>
            <el-table-column label="兼职职务" prop="jzzw"> </el-table-column>
            <el-table-column label="是否取酬" prop="sfqc"> </el-table-column>
            <el-table-column align="center">
              <template slot="header">
          ...
          >
            ...
            >
              ...
              <el-form-item label="组织类型" prop="zzlx">
                <el-select v-model="parttimejob_form.zzlx" placeholder="请选择">
                  <el-option
        ...
        <el-collapse-item title="服务协议子集">
          <el-table
            ...
            :header-cell-style="{ textAlign: 'center' }"
          >
            <el-table-column label="起始时间" prop="qssj"> </el-table-column>
            <el-table-column label="终止时间" prop="zzsj"> </el-table-column>
            ...
            <el-table-column align="center">
              <template slot="header">
                <el-button type="text" @click="openChild('servicetoenterprise')"
                  ><i class="el-icon-plus"></i>添加</el-button
                >
              </template>
              <template slot-scope="scope">
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              ...
              <el-button
                type="primary"
                @click="
                  submitChild('servicetoenterprise', servicetoenterprise_form)
                "
                >确 定</el-button
              >
            </span>
          ...
          <td>
            <el-row>
              ...
              >
                ...
                <el-col :span="12">
                  <el-form-item label="身份证号" prop="sfzjh">
                    <el-input v-model="examine_form.sfzjh" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
      ...
      <el-collapse accordion>
        <el-collapse-item title="教师资格证子集">
          <el-table
            ...
            :header-cell-style="{ textAlign: 'center' }"
          >
            <el-table-column label="资格种类" prop="zgzzl"> </el-table-column>
            <el-table-column label="资格证号码" prop="zgzhm"> </el-table-column>
            <el-table-column label="任教学科" prop="rjxk"> </el-table-column>
            <el-table-column label="发证机关" prop="fzjg"> </el-table-column>
            ...
            <el-table-column align="center">
              ...
              <template slot-scope="scope">
                <el-button type="text" @click="editChildRow('jszgz', scope.row)"
                  >修改</el-button
                >
                <el-button type="text" @click="delChildRow('jszgz', scope.row)"
                  >删除</el-button
                >
              </template>
            </el-table-column>
        ...
        <el-collapse-item title="职业资格证子集">
          <el-table
            ...
            :header-cell-style="{ textAlign: 'center' }"
          >
            <el-table-column label="职业工种" prop="zygz"> </el-table-column>
            <el-table-column label="职业等级" prop="zydj"> </el-table-column>
            <el-table-column label="颁证机构" prop="bzjg"> </el-table-column>
            <el-table-column label="证书编号" prop="zyzgzsbh">
            </el-table-column>
            <el-table-column label="取得时间" prop="zsbfrq"> </el-table-column>
            <el-table-column align="center">
              <template slot="header">
        ...
        <el-collapse-item title="教育培训子集">
          ...
          >
            ...
            <el-table-column label="培训班名称" prop="pxbmc"> </el-table-column>
            <el-table-column label="培训学时" prop="pxxs"> </el-table-column>
            <el-table-column label="培训类别" prop="pxlb"> </el-table-column>
            <el-table-column label="主办单位" prop="zbdw"> </el-table-column>
            ...
            <el-table-column align="center">
              ...
              <template slot-scope="scope">
                <el-button type="text" @click="editChildRow('train', scope.row)"
                  >修改</el-button
                >
                <el-button type="text" @click="delChildRow('train', scope.row)"
                  >删除</el-button
                >
              </template>
            </el-table-column>
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialogVisible_train = false">取 消</el-button>
              <el-button
                type="primary"
      ...
      <el-collapse accordion>
        <el-collapse-item title="因公/因私护照">
          <el-table
            ...
            :header-cell-style="{ textAlign: 'center' }"
          >
            <el-table-column label="类别" prop="hzzjzldm"> </el-table-column>
            <el-table-column label="护照号" prop="hzhtxzh"> </el-table-column>
            <el-table-column label="签发地点" prop="qfdd"> </el-table-column>
            <el-table-column label="签发日期" prop="qfrq"> </el-table-column>
            <el-table-column label="签发机关" prop="qfjg"> </el-table-column>
            <el-table-column label="终止日期" prop="zzrq"> </el-table-column>
            <el-table-column align="center">
              <template slot="header">
                <el-button type="text" @click="openChild('furtherstudyforeign')"
                  ><i class="el-icon-plus"></i>添加</el-button
                >
              </template>
              <template slot-scope="scope">
          ...
          >
            ...
            >
              ...
              <el-form-item label="护照号" prop="hzhtxzh">
                <el-input v-model="furtherstudyforeign_form.hzhtxzh"></el-input>
              </el-form-item>
              <el-form-item label="签发地点" prop="qfdd">
                <el-input v-model="furtherstudyforeign_form.qfdd"></el-input>
              </el-form-item>
              ...
              <el-form-item label="签发机关" prop="qfjg">
                <el-input v-model="furtherstudyforeign_form.qfjg"></el-input>
              </el-form-item>
            ...
            <span slot="footer" class="dialog-footer">
              ...
              <el-button
                type="primary"
                @click="
                  submitChild('furtherstudyforeign', furtherstudyforeign_form)
                "
                >确 定</el-button
              >
            </span>
        ...
        <el-collapse-item title="组织考察（考核）子集">
          ...
          >
            ...
            <span slot="footer" class="dialog-footer">
              ...
              <el-button
                type="primary"
                @click="submitChild('organiseinspect', organiseinspect_form)"
                >确 定</el-button
              >
            </span>
          </el-dialog>
...
import { chartData, listData } from "@/const/crud/page/wel";
import {
  info_form,
  office_form,
  examine_form,
