    ...
    <basic-container>
      <avue-crud
        ...
        <template slot="menuLeft" slot-scope="{size}">
          <el-button type="primary" :size="size" @click="handleApply()">申请竞聘</el-button>
        </template>
      </avue-crud>
    </basic-container>
  </div>
...
import {applyFormOption, applyOption} from "@/views/compete/apply/applyOption";
import {applyForm, checkApplyHistory, fetchReleaseList} from "@/api/compete/apply";
